...
def surf_runner(simplex_model, architecture, anchor, base1, base2, loader):
    ...
    X, Y, surf = compute_loss_surface(base_model, loader, 
                                 ...
                                 range_x = range_x, range_y = range_y, n_pts=50)
...
def plot(simplex_model, architechture, loader, base_idx):
  ...
  """
  cutoff012 = torch.clamp(surf012, 0.0, 1.0)
  
  cutoff013 = torch.clamp(surf013, 0.0, 1.0)
  cutoff023 = torch.clamp(surf023, 0.0, 1.0)
  cutoff123 = torch.clamp(surf123, 0.0, 1.0)
